...
def sync_role_info(logger, manifest_path, jenkins_config)
  ...
  # sync admin members
  admins = Array.new
  config_xml.each_element("hudson/authorizationStrategy/roleMap[@type='globalRoles']/role[@name='admin']/assignedSIDs/sid"){ |admin|
  ...
  config_xml.each_element("hudson/authorizationStrategy/roleMap[@type='projectRoles']/role"){ |role|
    members = Array.new
